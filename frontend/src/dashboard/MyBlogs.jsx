  ...
  return (
    <div>
      <div className="container mx-auto my-12 p-4">
        <div className="grid gap-6 md:grid-cols-1 lg:grid-cols-2 lg:ml-70 xl:grid-cols-3 md:ml-20">
          {myBlogs && myBlogs.length > 0 ? (
            myBlogs.map((element) => (
              ...
              >
                {element?.blogImage && (
                  <img
                    src={typeof element.blogImage === "string" ? element.blogImage : element.blogImage?.url}
                    alt="blogImg"
