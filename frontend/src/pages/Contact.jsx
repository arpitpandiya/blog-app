...
const Contact = () => {
  ...
  const onSubmit = async(data)=>{
    const userInfo ={
      access_key: "696cb5b0-946a-42ff-af52-5b0586e59e51",
      name: data.username,
      email: data.email,
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              <div>
                <input
                  ...
                  className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:border-2 focus:border-blue-600"
          ...
          <div className="w-full md:w-1/2 md:pl-4">
            ...
            <ul className="space-y-4">
              <li className="flex items-center space-x-2">
                ...
                <span>+91 8949486397</span>
              </li>
              <li className="flex items-center space-x-2">
                <FaEnvelope className="text-pink-500" />
                <span>thearpitpandiya@gmail.com</span>
              </li>
              <li className="flex items-center space-x-2">
